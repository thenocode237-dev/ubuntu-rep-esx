...
-- UBUNTU-RP : niveau de recherche GTA natif RÉACTIVÉ (défaut ESX = false, qui
-- appelait SetMaxWantedLevel(0) → jamais d'étoile pour un crime). Avec `true`,
-- commettre un crime en public fait apparaître les étoiles. Les renforts PNJ
-- restent limités par DisableDispatchServices = true ci-dessus (RP : on veut
-- l'indicateur d'étoiles, pas une armée de flics PNJ).
